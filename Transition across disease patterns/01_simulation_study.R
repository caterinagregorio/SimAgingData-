...
library(truncdist)
library(flexsurv)
source("fun//fun_simulate_mm.R")
source("fun//study_design_fun.R")
...
load(paste0("init/scenario",scenario,".RData"))
...
sim_test_list2 <- sim_mm_traj(nsim,N,scenario_obj = scenario_obj_B,seed=seed,scenario = "2")
